...
(function (h) {
  ...
  m.defaults = {
    ...
    oLanguage: {
      ...
      sInfo: "Hiện từ _START_ đến _END_ trong _TOTAL_ khoản chi",
      sInfoEmpty: "Hiện từ 0 đến 0 trong tổng 0 khoản chi",
      sInfoFiltered: "(lọc từ _MAX_ tổng số khoản chi)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Hiện _MENU_ khoản chi",
      sLoadingRecords: "Đang tải...",
      sProcessing: "Đang xử lý...",
      sSearch: "Tìm kiếm:",
      sSearchPlaceholder: "Tên khoản chi",
      sUrl: "",
